...
, bzip2, zlib, xorg, fontconfig, freetype, ghostscript, libjpeg
, lcms2, openexr, libpng, librsvg, libtiff, libxml2, openjpeg, libwebp
}:
# https://github.com/NixOS/nixpkgs/blob/fa6c6dae76a84dbbededa9b1053e4a90243b673f/pkgs/applications/graphics/ImageMagick/default.nix
let
  arch =
...
stdenv.mkDerivation rec {
  ...
  propagatedBuildInputs =
    ...
    ++ lib.optionals (stdenv.cross.libc or null != "msvcrt")
      [ xorg.libX11 xorg.libXext xorg.libXt libwebp ]
    ;
